...
const Header = () => {
  ...
  const icons = {
    ...
    arrowDown: <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" style={{ marginLeft: '4px' }}><path d="m6 9 6 6 6-6"/></svg>
  };
            ...
            <ul className={styles.navList}>
              ...
              <li className={styles.hasDropdown}>
                <div className={styles.mobileLinkRow} onClick={(e) => toggleDropdown('sanpham', e)}>
                  ...
                  <span className={`${styles.arrowIcon} ${activeDropdown === 'sanpham' ? styles.arrowUp : ''}`}>{icons.arrowDown}</span>
                </div>
              ...
              <li className={styles.hasDropdown}>
                <div className={styles.mobileLinkRow} onClick={(e) => toggleDropdown('dichvu', e)}>
                  ...
                  <span className={`${styles.arrowIcon} ${activeDropdown === 'dichvu' ? styles.arrowUp : ''}`}>{icons.arrowDown}</span>
                </div>
